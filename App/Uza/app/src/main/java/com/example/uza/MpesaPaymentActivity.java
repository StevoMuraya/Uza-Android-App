...
public class MpesaPaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit = findViewById(R.id.mpesa_submit);
        mpesa_code = findViewById(R.id.mpesa_payment_code);
        total_amount = findViewById(R.id.total_amount_mpesa);
        loading = findViewById(R.id.mpesa_loading);
        loading_screen = findViewById(R.id.mpesa_loading_screen);
    ...
    public void attempt_submit(){
        String mpesa_code_z       = mpesa_code.getText().toString();

        boolean cancel = false;
        View focusView = null;

        if (TextUtils.isEmpty(mpesa_code_z)) {
            mpesa_code.setError("Type the M-pesa code to proceed");
            focusView = mpesa_code;
            cancel = true;
        }else if (!isCodeLongEnough(mpesa_code_z)) {
            mpesa_code.setError("Code is too short");
            focusView = mpesa_code;
            cancel = true;
        }
        ...
        if (cancel) {
            ...
            paymentProcessing(shared_user_id,cost,"Mpesa",mpesa_code_z);
    ...
    private void load_cart(final String user_id){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, clsGlobal.ALL_CART_PRODUCTS,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            total_amount.setText("KShs "+(total_cost+300));
                            //Toast.makeText(MpesaPaymentActivity.this, "total_items"+total_items, Toast.LENGTH_SHORT).show();

                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(MpesaPaymentActivity.this, "Error 1", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(MpesaPaymentActivity.this, "Error 2", Toast.LENGTH_SHORT).show();
                    }
                }){
            @Override
        ...
        RequestQueue requestQueus = Volley.newRequestQueue(MpesaPaymentActivity.this);
    ...
    private void paymentProcessing(final String user_idx,final String payment_amountx,final String payment_methodx, final String payment_codex){
                        ...
                        if (response.equalsIgnoreCase("Successfully Updated")){
                            ...
                            new CountDownTimer(2500, 4000) {
                                ...
                                public void onFinish() {
                                    Toast.makeText(MpesaPaymentActivity.this, response, Toast.LENGTH_SHORT).show();
                                    loading.setVisibility(View.GONE);
                                    submit.setVisibility(View.VISIBLE);
                                    loading_screen.animate().alpha(0f).setDuration(500);
                                    loading_screen.setVisibility(View.GONE);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        new CountDownTimer(2500, 4000) {
                            ...
                            public void onFinish() {
                                ...
                                Toast.makeText(MpesaPaymentActivity.this, "Failed to send details", Toast.LENGTH_SHORT).show();
                                Toast.makeText(MpesaPaymentActivity.this, "Please try again later", Toast.LENGTH_SHORT).show();
                                loading.setVisibility(View.GONE);
                                submit.setVisibility(View.VISIBLE);
                                loading_screen.animate().alpha(0f).setDuration(500);
                                loading_screen.setVisibility(View.GONE);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(MpesaPaymentActivity.this);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(MpesaPaymentActivity.this, e.toString(), Toast.LENGTH_SHORT).show();
                    ...
                    public void onResponse(final String response) {
                        if (response.equalsIgnoreCase("Successfully Updated Cart")){
                            ...
                            if (total_items_check == total_items){
                                ...
                                loading_screen.animate().alpha(0f).setDuration(500);
                                loading_screen.setVisibility(View.GONE);
                                startActivity(new Intent(MpesaPaymentActivity.this, OrderConfirmationActivity.class));
                                finish();
                            }else{
    ...
    public void onBackPressed() {
        startActivity(new Intent(MpesaPaymentActivity.this,CheckOutActivity.class));
        finish();
    }
}
